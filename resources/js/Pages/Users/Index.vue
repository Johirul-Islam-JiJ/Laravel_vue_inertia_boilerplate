        ...
        >
            ...
            <template v-slot:default="slotProp">
                <div v-if="slotProp.item.deleted_at === 'Active'">
                    <Link
                        :href="route('users.assign.roles.form', slotProp.item)"
                        as="v-btn"
                        color="secondary"
                        icon
                        small
                    ...
                    <Link
                        :href="route('users.edit', slotProp.item)"
                        as="v-btn"
                        color="primary"
                        icon
                        small
                    ...
                    <Link
                        :href="route('users.destroy', slotProp.item)"
                        as="v-btn"
                        color="warning"
                        icon
                        method="delete"
                ...
                <div v-else>
                    <Link
                        :href="route('users.restore', slotProp.item)"
                        as="v-btn"
                        color="success"
                        icon
                        method="post"
            ...
            <template v-slot:roles="slotProp">
                <v-chip v-for="(role,index) in slotProp.item.roles"
                        :key="role.id"
