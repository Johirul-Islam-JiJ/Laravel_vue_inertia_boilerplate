		...
		>
			...
			<template v-slot:default="slotProp">
				<div v-if="slotProp.item.deleted_at === 'Active'">
					<Link
						:href="route('roles.assign.permissions.form', slotProp.item)"
						as="v-btn"
						color="secondary"
						icon
						small
					...
					<Link
						:href="route('roles.edit', slotProp.item)"
						as="v-btn"
						color="primary"
						icon
						small
					...
					<Link
						:href="route('roles.destroy', slotProp.item)"
						as="v-btn"
						color="warning"
						icon
						method="delete"
				...
				<div v-else>
					<Link
						:href="route('roles.restore', slotProp.item)"
						as="v-btn"
						color="success"
						icon
						method="post"
            ...
            <template v-slot:permissions="slotProp">
                <v-chip v-for="(permission,index) in slotProp.item.permissions"
                        :key="permission.id"
